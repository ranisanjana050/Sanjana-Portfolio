...
export const Mobilenav = () => {
  ...
  return (
    <div className='flex flex-col w-[18rem] p-7 shadow-md shadow-black  bg-black/70 backdrop-blur-xl rounded-3xl  fixed text-3xl   top-12 right-0 z-10'>
      <div className='flex flex-col  '>
        ...
        <div className="mt-4 ">
          <a
            href={Bio.github} target='_blank' rel='noreferrer'

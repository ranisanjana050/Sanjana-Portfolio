  ...
  return (
    <div className="bg-black" id="contact" >
      <div className="flex  flex-col justify-center items-center  ">
        ...
        <form
         action="https://formspree.io/f/xgvgqojz"
         method="POST"
        ...
        <h1 className=" md:text-6xl lg:text-7xl xl:text-[110px]  -mb-[0.55rem] md:font-extrabold text-3xl text-[#1C1C27] font-extrabold md:-mb-[0.6rem] lg:-mb-[0.8rem] xl:-mb-[1.2rem]">
          SANJANA SINGH
        </h1>
      </div>
    </div>
